...
fig_pressure_depth.update_layout(title='pressure vs. depth',
                   xaxis_title='kPa',
...
fig_depth.update_layout( xaxis_title='time [h]',
                   yaxis_title='depth [m]')
fig_depth.show()
...
fig_pressure.update_layout( xaxis_title='time [h]',
...
fig_temprature.update_layout(xaxis_title='time [h]',
                   yaxis_title='temp [°C]')
fig_temprature.show()
...
fig_pollution.update_layout(xaxis_title='time [h]',
                   yaxis_title='pollution [ppm]')
fig_pollution.show()
...
firstpage = [
    ...
    dbc.Row([
        dbc.Col([
            html.H6('Select the field  you want to look into:', className='text-center mb-2 p-1'),
            dcc.Dropdown(
                id = 'field-dropdown',
                options = fields,
            ...
            html.H6('Select the buoy you want to look into:', className='text-center mb-2 p-1'),
            dcc.Dropdown(
                id = 'id-dropdown',
                options = ids,
                value = ids[0]['label'],
            ...
            # Could have here displayed data about the the specific ID
        ...
        dbc.Col([
            ...
            html.H5('Pollution levels on all buoy ids', className='text-center p-1'),
    ...
    dbc.Row([
        dbc.Col([
            ...
            html.H6('How deep is your love', className='text-center font-italic'),
        ...
        dbc.Col([
            ...
            html.H6('How much pressure on the device', className='text-center font-italic'),
        ...
        dbc.Col([
            ...
            html.H6('How hot is the water', className='text-center font-italic'),
        ...
        dbc.Col([
            ...
            html.H6('Oil spill in the area', className='text-center font-italic'),
...
@app.callback(
    [
        Output("allpressurechart", "figure"), Output("depthchart", "figure"), Output("pressurechart", "figure"), Output("tempraturechart", "figure"),
...
def update_figure(field, robot_id):    
    ...
    return fig_depth, fig_pressure, fig_temprature, fig_pollution, fig_all_pressure
